...
module Match
  class Importer
    def import_cert(params, cert_path: nil, p12_path: nil, profile_path: nil)
      ...
      cert_path = params[:cert_path] || ensure_valid_file_path(cert_path, "Certificate", ".cer")
      p12_path = params[:p12_path] || ensure_valid_file_path(p12_path, "Private key", ".p12")
      profile_path = params[:profile_path] || ensure_valid_file_path(profile_path, "Provisioning profile", ".mobileprovision or .provisionprofile", optional: true)
